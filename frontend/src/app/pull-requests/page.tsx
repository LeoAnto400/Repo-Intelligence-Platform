...
import { PullRequestsList } from '@/features/pull-requests/components/PullRequestsList';
...
export default function PullRequestsPage() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <p className="text-xs font-medium uppercase tracking-[0.18em] text-indigo-300">Pull requests</p>
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-zinc-50">Pull Requests</h1>
      </div>
      <PullRequestsList />
    </section>
  );
